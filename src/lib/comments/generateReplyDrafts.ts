...
export const TONE_VALUES = ['friendly', 'professional', 'careful'] as const;
...
export async function generateReplyDrafts({
  ...
  const resolvedTone: Tone = TONE_VALUES.includes(tone as Tone) ? (tone as Tone) : 'friendly';
